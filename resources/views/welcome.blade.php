...
<body>
    ...
    <div class="container"  >
        <div class="row text-center">
            <div  class="col-md-12" >
                <span class="head-main" >Selamat Datang</span>
                <h3 class="head-last col-md-8 col-md-offset-2  col-sm-8 col-sm-offset-2">/ PT CUP INDONESIA /</h3>
    ...
    <section id="about"  >
        <div class="container">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-adjust">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
                                    <i class="fa fa-plus"></i> Alamat PT CUP
                                </a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title panel-title-adjust">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                    <i class="fa fa-plus"></i>Contact us
                                </a>
                            </h4>
                        </div>
           ...
           Aenean eget ligula id nulla ornare placerat vel a nulla. 
                 ...
                 <div class="col-md-6 ">
                     <h1 ><center>PT CUP</h1></center>
                     <h4></h4>
                     <p>
                                  <center>Telah Berdiri Sejak Tahun 2000</center> 
                ...
                <div id="carousel-example" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item next left">
                            <div class="container center">
                                <div class="col-md-6 col-md-offset-3 slide-custom">
                                    <h4><i class="fa fa-quote-left"></i>Kita bisa mengubah arah angin, tapi kita bisa menmafaatkannya untuk mencapai tujuan berlayar kita <i class="fa fa-quote-right"></i></h4>
                                        <div class="user-img pull-right">
